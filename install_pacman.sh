...
ZSTD_EXE="https://github.com/facebook/zstd/releases/download/v1.5.2/zstd-v1.5.2-win64.zip"
...
download_file "zstd-v1.5.2-win64.zip" $ZSTD_EXE
...
unzip -o ./zstd-v1.5.2-win64.zip "zstd-v1.5.2-win64/zstd.exe" -d .
./zstd-v1.5.2-win64/zstd.exe -f -d -o ${ZSTD%.zst} $ZSTD
